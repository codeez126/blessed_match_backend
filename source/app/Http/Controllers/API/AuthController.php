...
class AuthController extends Controller
{
    public function register(Request $request)
    {
        ...
        try {
            // Check if user exists by email (for all auth types)
            ...
            $response = [
                'status' => true,
                'message' => $request->auth_type === 'email'
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if ($validator->fails()) {
            return $this->apiResponse([], 'Validation error', 422, $validator->errors());
        }
    ...
    public function mmRegistration(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'office_type' => 'required|in:Home,Office,Virtual',
        ...
        try {
            ...
            $mmProfile = MmProfile::updateOrCreate(
                ...
                [
                    ...
                    'my_refral_code' => $user->email ?? null,
            ...
            ], 'Matchmaker profile created successfully');
...
//            saving avg
    ...
    public function onBoarding6(Request $request)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'skin_color' => 'nullable|integer|between:1,9',
    ...
    public function clientParagraph($id)
    {
        ...
        $genderText = $about->gender == 1 ? 'Boy' : 'Girl';
        $pronoun = $about->gender == 1 ? 'He' : 'She';
        $possessive = $about->gender == 1 ? 'His' : 'Her';
