            ...
            ">
                <table class="table mb-0" style="width:100%; border-collapse:collapse;">
                    ...
                    @if(!empty($sibling->full_name))
                        <tr>
                            <td style="width:40%;border-right: 1px solid #e1d2d2;"><strong>Name</strong></td>
                    ...
                    @if(!empty($sibling->age))
                        <tr>
                            <td style="border-right: 1px solid #e1d2d2;"><strong>Age</strong></td>
                            <td>{{ $sibling->age }}</td>
                        </tr>
                    @endif
                    ...
                    @if(!empty($sibling->gender_id))
                        <tr>
                            <td style="border-right: 1px solid #e1d2d2;"><strong>Gender</strong></td>
                    ...
                    @if(!empty($sibling->maritalStatus?->name))
                        <tr>
                            <td style="border-right: 1px solid #e1d2d2;"><strong>Marital Status</strong></td>
                    ...
                    @if(!empty($sibling->designation))
                        <tr>
                            <td style="border-right: 1px solid #e1d2d2;"><strong>Designation</strong></td>
                    ...
                    @if(!empty($sibling->description))
                        <tr>
                            <td style="border-right: 1px solid #e1d2d2;"><strong>Description</strong></td>
