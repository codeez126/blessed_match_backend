...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href=" {{asset($profile_Image)}}"/>
    <meta name="msapplication-TileColor" content="#da532c">
    <meta name="theme-color" content="#ffffff">
    <meta name="robots" content="noindex,nofollow">
    <meta name="keywords" content="Asan Rishta">
    <meta name="description" content="{{$description}}">
    <meta name="author" content="Asan Rishta">

    <meta property="og:image" content="{{asset($profile_Image)}}"/>
    <meta property="og:title" content="{{$user->clientAbout->full_name ?? 'Asan Rishta'}}"/>
    ...
    <meta name="twitter:title" content="{{$user->clientAbout->full_name ?? 'Asan Rishta'}}" />
    <meta name="twitter:description" content="{{$description}}" />
    <meta name="twitter:image" content="{{asset($profile_Image)}}"/>
    ...
    <div class="profile-card">
        ...
        <div class="basic-info-container">
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="text-end profile-completed-div">Profile Completed {{ round($user->profileAvg->total_avg) }}%</div>
                    <div class="progress" style="height: 20px;">
                        <div class="progress-bar custom-progress" role="progressbar" style="width: 90%;" aria-valuenow="{{ round($user->profileAvg->total_avg) }}" aria-valuemin="0" aria-valuemax="100">
                        </div>
                    </div>
                </div>
            </div>
