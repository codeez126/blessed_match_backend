...
@section('contents')
            ...
            <div class="row justify-content-center">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="banner__inputlist" for="male">
                                                <input type="radio" id="male" name="me" class="male" checked="">
                                                <span>Male</span>
                ...
                <div class="col-lg-6 col-12">
                    <div class="banner__thumb banner__thumb--thumb1 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="{{asset('assets/front')}}/images/banner/01.png" alt="banner">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4 justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="about__item text-center">
                            <div class="about__inner">
                                <div class="about__thumb">
                                    <img src="{{asset('assets/front')}}/images/about/01.jpg" alt="dating thumb">
                                </div>
                    ...
                    <div class="col wow fadeInUp" data-wow-duration="1.5s">
                        <div class="about__item text-center">
                            <div class="about__inner">
                                <div class="about__thumb">
                                    <img src="{{asset('assets/front')}}/images/about/02.jpg" alt="dating thumb">
                                </div>
                                <div class="about__content">
                    ...
                    <div class="col wow fadeInUp" data-wow-duration="1.5s">
                        <div class="about__item text-center">
                            <div class="about__inner">
                                <div class="about__thumb">
                                    <img src="{{asset('assets/front')}}/images/about/03.jpg" alt="dating thumb">
                                </div>
                                <div class="about__content">
                    ...
                    <div class="col wow fadeInUp" data-wow-duration="1.5.5s">
                        <div class="about__item text-center">
                            <div class="about__inner">
                                <div class="about__thumb">
                                    <img src="{{asset('assets/front')}}/images/about/04.jpg" alt="dating thumb">
                                </div>
                                <div class="about__content">
            ...
            <div class="section__wrapper wow fadeInUp" data-wow-duration="1.5s">
                <div class="d-xl-flex align-items-start work__area">
                    <div class="nav flex-xl-column nav-pills me-xl-4 work__tablist" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link" id="work__tab1-tab" data-bs-toggle="pill" data-bs-target="#work__tab1" type="button" role="tab" aria-controls="work__tab1" aria-selected="true"><img src="{{asset('assets/front')}}/images/work/01.png" alt="dating thumb" class="me-3"><span>Search Your Partner</span></button>
                        <button class="nav-link active" id="work__tab2-tab" data-bs-toggle="pill" data-bs-target="#work__tab2" type="button" role="tab" aria-controls="work__tab2" aria-selected="false"><img src="{{asset('assets/front')}}/images/work/02.png" alt="dating thumb" class="me-3"><span>100% Match People</span></button>
                        <button class="nav-link" id="work__tab3-tab" data-bs-toggle="pill" data-bs-target="#work__tab3" type="button" role="tab" aria-controls="work__tab3" aria-selected="false"><img src="{{asset('assets/front')}}/images/work/03.png" alt="dating thumb" class="me-3"><span>Find Out Partner</span></button>
                        <button class="nav-link" id="work__tab4-tab" data-bs-toggle="pill" data-bs-target="#work__tab4" type="button" role="tab" aria-controls="work__tab4" aria-selected="false"><img src="{{asset('assets/front')}}/images/work/04.png" alt="dating thumb" class="me-3"><span>Live The Story</span></button>
                    </div>
                    <div class="tab-content work__tabcontent" id="v-pills-tabContent">
                            ...
                            <div class="work__item">
                                <div class="work__inner">
                                    <div class="work__thumb">
                                        <img src="{{asset('assets/front')}}/images/work/05.png" alt="dating thumb">
                                    </div>
                        ...
                        <div class="tab-pane fade show active" id="work__tab2" role="tabpanel" aria-labelledby="work__tab2-tab">
                            <div class="work__item">
                                <div class="work__inner">
                                    <div class="work__thumb">
                                        <img src="{{asset('assets/front')}}/images/work/06.png" alt="dating thumb">
                                    </div>
                                    <div class="work__content">
                        ...
                        <div class="tab-pane fade" id="work__tab3" role="tabpanel" aria-labelledby="work__tab3-tab">
                            <div class="work__item">
                                <div class="work__inner">
                                    <div class="work__thumb">
                                        <img src="{{asset('assets/front')}}/images/work/07.png" alt="dating thumb">
                                    </div>
                                    <div class="work__content">
                        ...
                        <div class="tab-pane fade" id="work__tab4" role="tabpanel" aria-labelledby="work__tab4-tab">
                            <div class="work__item">
                                <div class="work__inner">
                                    <div class="work__thumb">
                                        <img src="{{asset('assets/front')}}/images/work/08.png" alt="dating thumb">
                                    </div>
                                    <div class="work__content">
        ...
        <div class="container">
            ...
            <div class="section__wrapper wow fadeInUp" data-wow-duration="1.5s">
                <ul class="member__buttongroup filters-button-group w-100 d-flex flex-wrap justify-content-center">
                    ...
                    <li class="button filter-btn" data-filter=".male"><span class="member__radio"></span> Male <span class="banner__inputlist--icon"><i class="fa-solid fa-mars"></i></span></li>
                    <li class="button filter-btn" data-filter=".female"><span class="member__radio"></span> Female <span class="banner__inputlist--icon"><i class="fa-solid fa-venus"></i></span></li>
                </ul>
                ...
                <div class="member__grid mx-12-none">
                    <div class="member__item male">
                        <div class="member__inner">
                            <div class="member__thumb">
                                <img src="{{asset('assets/front')}}/images/member/male/01.jpg" alt="member-img">
                    ...
                    <div class="member__item female">
                        <div class="member__inner">
                            <div class="member__thumb">
                                <img src="{{asset('assets/front')}}/images/member/female/01.jpg" alt="member-img">
                    ...
                    <div class="member__item male">
                        <div class="member__inner">
                            <div class="member__thumb">
                                <img src="{{asset('assets/front')}}/images/member/male/02.jpg" alt="member-img">
                                <span class="member__activity">Online</span>
                            </div>
                            <div class="member__content">
                    ...
                    <div class="member__item female">
                        <div class="member__inner">
                            <div class="member__thumb">
                                <img src="{{asset('assets/front')}}/images/member/female/02.jpg" alt="member-img">
                    ...
                    <div class="member__item male">
                        <div class="member__inner">
                            <div class="member__thumb">
                                <img src="{{asset('assets/front')}}/images/member/male/03.jpg" alt="member-img">
                                <span class="member__activity">Online</span>
                            </div>
                            <div class="member__content">
                ...
                <div class="row g-4 justify-content-center row-cols-lg-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="story__item">
                            <div class="story__inner">
                                <div class="story__thumb">
                                    <a href="blog-single.html"><img src="{{asset('assets/front')}}/images/story/01.jpg" alt="dating thumb"></a>
                                ...
                                <div class="story__content">
                                    ...
                                    <div class="story__content--author">
                                        <div class="story__content--thumb">
                                            <img src="{{asset('assets/front')}}/images/story/author/01.jpg" alt="dating thumb">
                                        </div>
                    ...
                    <div class="col">
                        <div class="story__item">
                            <div class="story__inner">
                                <div class="story__thumb">
                                    <a href="blog-single.html"><img src="{{asset('assets/front')}}/images/story/02.jpg" alt="dating thumb"></a>
                                ...
                                <div class="story__content">
                                    ...
                                    <div class="story__content--author">
                                        <div class="story__content--thumb">
                                            <img src="{{asset('assets/front')}}/images/story/author/02.jpg" alt="dating thumb">
                                        </div>
                                        <div class="story__content--content">
                                            <h6>Arika Q Smith</h6>
                                            <p>March 14, 2022</p>
                    ...
                    <div class="col">
                        <div class="story__item">
                            <div class="story__inner">
                                <div class="story__thumb">
                                    <a href="blog-single.html"><img src="{{asset('assets/front')}}/images/story/03.jpg" alt="dating thumb"></a>
                                ...
                                <div class="story__content">
                                    ...
                                    <div class="story__content--author">
                                        <div class="story__content--thumb">
                                            <img src="{{asset('assets/front')}}/images/story/author/03.jpg" alt="dating thumb">
                                        </div>
                                        <div class="story__content--content">
                                            <h6>William Show</h6>
                                            <p>June 18, 2022</p>
    ...
    <div class="meet padding-top padding-bottom">
        <div class="container">
            <div class="section__header style-2 text-center wow fadeInUp" data-wow-duration="1.5s">
            ...
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center wow fadeInUp" data-wow-duration="1.5s">
                    <div class="col-lg-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/01.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/01.jpg" alt="dating thumb">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/02.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/02.jpg" alt="dating thumb">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/03.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/03.jpg" alt="dating thumb">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/04.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/04.jpg" alt="dating thumb">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/05.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/05.jpg" alt="dating thumb">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="meet__item">
                            <div class="meet__inner">
                                <div class="meet__thumb">
                                    <a href="members.html"><img src="{{asset('assets/front')}}/images/meet/06.jpg" alt="dating thumb"></a>
                                </div>
                                <div class="meet__content">
                                    <img src="{{asset('assets/front')}}/images/meet/icon/06.jpg" alt="dating thumb">
                ...
                <div class="text-center mt-5 wow fadeInUp" data-wow-duration="1.5s">
                    <a href="members.html" class="default-btn"><span>Search Near You</span></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-12 wow fadeInLeft" data-wow-duration="1.5s">
                        <div class="work__item">
                            <div class="work__inner">
                                <div class="work__thumb">
                                    <img src="{{asset('assets/front')}}/images/work/09.png" alt="dating thumb">
                                </div>
                                <div class="work__content">
                    ...
                    <div class="col-xl-6 col-lg-8 col-12 wow fadeInRight" data-wow-duration="1.5s">
                        <div class="work__item">
                            <div class="work__inner">
                                <div class="work__thumb">
                                    <img src="{{asset('assets/front')}}/images/work/10.png" alt="dating thumb">
                                </div>
                                <div class="work__content">
                    ...
                    <div class="app__item">
                        <div class="app__inner">
                            <div class="app__content">
                                ...
                                <ul>
                                    <li><a href="#"><img src="{{asset('assets/front')}}/images/app/01.jpg" alt="dating thumb"></a></li>
                                    <li><a href="#"><img src="{{asset('assets/front')}}/images/app/02.jpg" alt="dating thumb"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="app__item">
                        <div class="app__inner">
                            <div class="app__thumb">
                                <img src="{{asset('assets/front')}}/images/app/01.png" alt="dating thumb">
                            </div>
                        </div>
                    </div>
                </div>
