            ...
            (function(global) {
                (function() {
                        ...
                        v = function(t, e, s, i, n) {
                            ...
                            if (t.attributes && e.attributes) {
                                ...
                                if (t.attributes.class && t.attributes.class === e.attributes.class)
                                    if ("".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, ".")) in s) return !0
                            }
                            if (i) return !0;
                    ...
                    function M(t, e) {
                        ...
                        if (t instanceof Text || t instanceof Comment) s.data = t.data;
                        else {
                    ...
                    var $ = {
                        ...
                        C = function(t, e) {
                            ...
                            return t.replace(E, (function(o, r) {
                                var l = "/" !== o.charAt(1),
                                    d = o.startsWith("\x3c!--"),
                                    c = r + o.length,
                                    h = t.charAt(c);
                        ...
                        L = function() {
                            ...
                            return t.prototype.init = function() {
                                ...
                                }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), m = [], b = 0, w = 0; b < f; w += 1, b += 1)
                                    if (!n || !0 !== u[b] && !0 !== p[b]) {
                                        if (!0 === u[b])
                                                ...
                                                if ("#text" === e.childNodes[b].nodeName) {
                                                    if (l.data !== e.childNodes[b].data) {
                                                        for (c = w; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName;)
                                                            if (c += 1, e.childNodes[b].data === t.childNodes[c].data) {
                                                                d = !0;
                                                                break
                                        ...
                                        else if (!0 === p[b]) "#text" === (l = e.childNodes[b]).nodeName ? (m.push((new x).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 0, !0), f = Math.min(u.length, p.length), w -= 1) : (m.push((new x).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 0, !0), f = Math.min(u.length, p.length), w -= 1);
                                        else if (u[b] !== p[b]) {
                        ...
                        k = function() {
                            ...
                            return t.prototype.apply = function(t, e) {
                                ...
                                return new L(t, e, this.options).init()
                            }, t
                        }();
                    const A = (t, e, s, {
                            classes: i,
                                ...
                                return t.forEach((t => {
                                    (Array.isArray(t.select) ? t.select : [t.select]).forEach((o => {
                                        ...
                                        t.render && (r.render = t.render), t.format ? r.format = t.format : "date" === t.type && (r.format = s), t.cellClass && (r.cellClass = t.cellClass), t.headerClass && (r.headerClass = t.headerClass), t.locale && (r.locale = t.locale), !1 === t.sortable ? r.sortable = !1 : (t.numeric && (r.numeric = t.numeric), t.caseFirst && (r.caseFirst = t.caseFirst)), !1 === t.searchable ? r.searchable = !1 : t.sensitivity && (r.sensitivity = t.sensitivity), (r.searchable || r.sortable) && t.ignorePunctuation && (r.ignorePunctuation = t.ignorePunctuation), t.hidden && (r.hidden = !0), t.filter && (r.filter = t.filter), t.sortSequence && (r.sortSequence = t.sortSequence), t.sort && (t.filter ? a[o] = t.sort : n = {
                                            column: o,
                                            dir: t.sort
                                        }), void 0 !== t.isSplitQueryWord && (r.isSplitQueryWord = t.isSplitQueryWord), void 0 !== t.searchQuerySeparator && (r.searchQuerySeparator = t.searchQuerySeparator)
                                    }))
                                })), i = i.map((t => t || {
                                    type: e,
                    ...
                    const z = {
                        ...
                        J = (t, e, s, i, n) => {
                            let a = [];
                            if (n.firstLast && a.push(U(1, n.firstText, n)), n.nextPrev) {
                                const e = t ? 1 : s - 1;
                                a.push(U(e, n.prevText, n, {
                                    hidden: t
                                }))
                            }
                            let o = [...Array(i).keys()].map((t => U(t + 1, String(t + 1), n, {
                                active: t === s - 1
                            })));
                            if (n.truncatePager && (o = ((t, e, s, i) => {
                                ...
                                const t = e ? i : s + 1;
                                a.push(U(t, n.nextText, n, {
                                    hidden: e
                                }))
                            }
                            n.firstLast && a.push(U(i, n.lastText, n));
                            return {
                                nodeName: "UL",
                                attributes: {
                    ...
                    class X {
                        ...
                        keydown(t) {
                            if (this.modalDOM) {
                                if ("Escape" === t.key) this.options.cancelModal(this) && this.closeModal();
                                else if ("Enter" === t.key)
                                    if (this.editingCell) {
                    ...
                    // document.addEventListener('DOMContentLoaded', function() {
                        ...
                        constructor(t, e = {}) {
                            ...
                            }, this._dd = new k(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }
                        init() {
                            ...
                            }, this.rows = new F(this), this.columns = new Q(this), this.data = W(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
                        ...
                        _render() {
                            ...
                            t && this.options.paging && this.options.perPageSelect ? this.options.perPageSelect.forEach((e => {
                                const [s, i] = Array.isArray(e) ? [e[0], e[1]] : [String(e), e], n = i === this.options.perPage, a = new Option(s, String(i), n, n);
                                t.appendChild(a)
                        ...
                        _renderPagers() {
                            ...
                            let t = J(this.onFirstPage, this.onLastPage, this._currentPage, this.totalPages, this.options);
                        ...
                        multiSearch(t) {
                            ...
                            this.data.data.forEach(((t, s) => {
                                ...
                                e.every((t => t.find(((t, e) => !!t && (this.columns.settings[e].isSplitQueryWord ? t.split(this.columns.settings[e].searchQuerySeparator) : [t]).find((t => i[e].includes(t.trim()))))))) && this._searchData.push(s)
                        ...
                        insert(e) {
                            ...
                            } else t(e) && (!e.headings || this.hasHeadings || this.hasRows ? e.data && Array.isArray(e.data) && (s = e.data.map((t => t.map(((t, e) => q(t, this.columns.settings[e])))))) : this.data = W(e, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        exports.createElement = s, exports.exportCSV = function(e, s = {}) {
                        ...
                        if (a[0] = o, i.selection)
                            if (Array.isArray(i.selection))
                                for (let t = 0; t < i.selection.length; t++) a = a.concat(e.pages[i.selection[t] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data)))));
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection))
                                for (let t = 0; t < i.selection.length; t++) a = a.concat(e.pages[i.selection[t] - 1].map((t => t.row.filter(((t, e) => n(e))).map((t => t.data)))));
                        ...
                        return !1
                            ...
                            exports.isJson = e, exports.isObject = t,
